	...
	*/
	...
	class ezSQL_pdo extends ezSQLcore
	{
		...
		function check_database_version() {
			...
			if ( version_compare( $this->db_version(), $mysql_version, '<'))
				return 'database_version ' . sprintf( '<strong>ERROR</strong>: QR Manager %1$s requires MySQL %2$s or higher' , QRGEN_VERSION, $mysql_version );
			else
				return false;
		}
